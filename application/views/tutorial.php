...
<body>
   ...
   <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
				<iframe width="560" height="315" src="<?php echo $mli->ly?>" frameborder="0" allowfullscreen></iframe>
                
            </div>
			
            <div class="col-md-6">
                <h3><?php echo $mli->judul?></h3>
                <p><?php echo $mli->details?></p>
                <a class="btn btn-primary" <?=anchor('welcome/detail_tutor/'.$mli->id,'Read More',['class'=>'glyphicon glyphicon-chevron-right'])?></a>
            </div>
        </div>
		<hr>
		<?php endforeach; ?>
