	...
	<body>
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<?= form_open_multipart('admin/tutor/update/'.$id,['class'=>'form-horizontal']) ?>
					  ...
					  <div class="form-group">
						...
						<div class="col-sm-10">
						  <input type="text" class="form-control" name="ly" placeholder="" value="<?=$ly?>">
						</div>
					  </div>
